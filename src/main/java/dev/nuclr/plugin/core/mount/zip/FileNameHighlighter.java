...
final class FileNameHighlighter {
	...
	private static final Set<String> TEXT_EXTENSIONS    = Set.of(
			...
			"json", "xml", "csv", "log", "ini", "cfg", "conf", "properties",
			"yaml", "yml", "sh", "bat", "ps1", "pdf");
	private static final Set<String> IMAGE_EXTENSIONS   = Set.of(
			"png", "jpg", "jpeg", "bmp", "gif", "svg", "webp", "ico", "tiff", "psd", "ai", "eps");
	private static final Set<String> AUDIO_EXTENSIONS   = Set.of(
			"mp3", "wav", "xm", "mod", "s3m", "it", "669", "mid", "midi");
	private static final Set<String> ARCHIVE_EXTENSIONS = Set.of(
			"zip", "jar", "rar", "tar", "gz");
	private static final Set<String> VIDEO_EXTENSIONS   = Set.of(
			"mp4", "mkv", "mov", "avi", "webm", "ts", "m2ts", "mxf",
	...
	Color colorFor(ZipFilePanelModel.Entry entry) {
		...
		if (TEXT_EXTENSIONS.contains(extension))    return textFileColor;
		if (IMAGE_EXTENSIONS.contains(extension))   return imageFileColor;
		if (AUDIO_EXTENSIONS.contains(extension))   return audioFileColor;
		if (ARCHIVE_EXTENSIONS.contains(extension)) return archiveFileColor;
		if (VIDEO_EXTENSIONS.contains(extension))   return videoFileColor;
		return defaultColor;
	}
